 ...
 * 
 */
public class OrientDBTest extends AbstractCyNetworkTest {

	private static final String TEMP_DB = "target" + File.separator + "orientDB";
	...
	public void clearDB() throws Exception {
		...
		((OrientGraph) graphImplementation).clear();
		//manager.close();
	}
